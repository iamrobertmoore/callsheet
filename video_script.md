...
**Spoken Word Count**: 312 words across 160 seconds (117 words/minute average; steady and deliberate)  
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **1** | 0:00 - 0:18 | 18s | **37 words** | 123.3 wpm | Producer persona & penalty stakes |
...
| :--- | :--- | :--- | :--- |
| **1** | Full view of live deployment at `https://callsheet-746874807798.us-central1.run.app`. Cursor hovers over **Chronicles of Aethelgard: Episode 6** card on the Active Delivery Slate. | "Elena Vance is the delivery producer persona I designed Callsheet around. She delivers visual effects for episodic television, with an episode due this afternoon. Missing that deadline triggers an immediate penalty of twenty-five thousand pounds per day." *(37 words)* | **0:00 - 0:18** (18s) |
...
- **Timing Discipline**: The recording ends at 2:40, leaving an absolute 20-second buffer before the 3:00 hard evaluation cutoff. Speak at an unhurried, measured pace (~117 words per minute).
